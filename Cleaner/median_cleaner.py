# median_cleaner.py
# Ce script nettoie les données brutes et remplace les valeurs manquantes par la médiane
...
def clean_data(input_file, output_file):
    ...
    # Appliquer SimpleImputer sur chaque ligne individuellement
...
if __name__ == "__main__":
    ...
    output_file_path = '../Cleaned_Data/Fraud_mediancleaned.csv'
