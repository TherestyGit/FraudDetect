...
def decision_tree(fraud_file_path):
    ...
    predictions_df.to_csv("Results/decision_tree_results.csv", index=False)
    perf_df.to_csv("Results/decision_tree_performance.csv", index=False)
    print("Voici les prédictions :")
    print(predictions_df)
    print("\nLes prédictions ont été sauvegardées dans le dossier Results et le fichier decision_tree_results.csv")
    print("Les performances du modèle ont été sauvegardées dans le dossier Results et le fichier decision_tree_performance.csv")