...
def gradient_boosting_regression(fraud_file_path):
    ...
    fraud_model = GradientBoostingRegressor(random_state=1)
    ...
    predictions_df.to_csv("Results/gradiant_boosting_regressor_results.csv", index=False)
    perf_df.to_csv("Results/gradiant_boosting_regressor_performance.csv", index=False)
    print("Voici les prédictions :")
    print(predictions_df)
    print("\nLes prédictions ont été sauvegardées dans le dossier Results et le fichier gradiant_boosting_regressor_results.csv")
    print("Les performances du modèle ont été sauvegardées dans le dossier Results et le fichier gradiant_boosting_regressor_performance.csv")