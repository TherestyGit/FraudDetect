...
def kmeans(fraud_file_path):
    ...
    fraud_model = KMeans(n_clusters=3, random_state=1)
    ...
    fraud_data.to_csv("Results/kmeans_results.csv", index=False)
    print("Voici les prédictions :")
    print(fraud_data)
    print("\nLes prédictions ont été sauvegardées dans le dossier Results et le fichier kmeans_results.csv")