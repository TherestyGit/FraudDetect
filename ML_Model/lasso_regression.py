...
def lasso_regression(fraud_file_path):
    ...
    predictions_df.to_csv('Results/lasso_regression_results.csv', index=False)
    perf_df.to_csv("Results/lasso_regression_performance.csv", index=False)
    print("Voici les prédictions :")
    print(predictions_df)
    print("\nLes prédictions ont été sauvegardées dans le dossier Results et le fichier lasso_regression_results.csv")
    print("Les performances du modèle ont été sauvegardées dans le dossier Results et le fichier lasso_regression_performance.csv")