...
def linear_regression(fraud_file_path):
    ...
    predictions_df.to_csv('Results/linear_regression_results.csv', index=False)
    perf_df.to_csv("Results/linear_regression_performance.csv", index=False)
    print("Voici les prédictions :")
    print(predictions_df)
    print("\nLes prédictions ont été sauvegardées dans le dossier Results et le fichier linear_regression_results.csv")
    print("Les performances du modèle ont été sauvegardées dans le dossier Results et le fichier linear_regression_performance.csv")